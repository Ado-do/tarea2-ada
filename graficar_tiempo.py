...
def graficar_tiempo():
    ...
    try:
        ...
        df = pd.read_csv("build/resultados_tiempo.csv")
    ...
    ax.set_title(
        "Comparación de Tiempo de Ejecución de Algoritmos ", fontsize=20, pad=20
    )
    ax.set_xlabel(
        "Comparación de Textos (Longitud1 vs Longitud2)", fontsize=14, labelpad=15
    )
    ax.set_ylabel(
        "Tiempo de Ejecución en Segundos (Escala Logarítmica)", fontsize=14, labelpad=15
    )
    ...
    nombre_archivo = "build/grafico_tiempo.png"
